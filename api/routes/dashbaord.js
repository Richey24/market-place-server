...
router.get("/sales-report/:startDate/:endDate/:companyId?", dashboardController.getSalesReport);
router.get(
     "/best-selling/:startDate/:endDate/:companyId?",
     dashboardController.getBestSellingProducts,
);
router.get(
     "/total-orders/:startDate/:endDate/:companyId?",
     dashboardController.getOrdersByCustomers,
);
router.get(
     "/customers-revenue/:startDate/:endDate/:companyId?",
     dashboardController.getRevenueByCustomers,
);
